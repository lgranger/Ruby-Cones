...
class AboutIteration < Neo::Cone
  ...
  # convert to the right format in the Cones. We will use "as_name"
  ...
  # Bonus Question:  At the previous Cone, we saw the construct:
  #
  ...
  #   # code to read 'file'
  #
  # When you get to the "AboutSandwichCode" Cone, recheck your answer.
