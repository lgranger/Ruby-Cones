...
# of the Proxy class is given in the AboutProxyObjectProject Cone.
...
# The proxy object should pass the following Cone:
#
class AboutProxyObjectProject < Neo::Cone
